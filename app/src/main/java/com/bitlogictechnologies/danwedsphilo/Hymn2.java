...
public class Hymn2 extends AppCompatActivity {
    DataArray dataArray;
    ListAdapter listAdapter;
    ListView lv_order;
    ArrayList<String> hymn2_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_title_text.setText("\tHymn Two 2");
    ...
    public void load_hymn2_order(){
        dataArray=new DataArray();

        final String [] hymn2_string_array= dataArray.hymn2_order;
        hymn2_list=new ArrayList<String>(Arrays.asList(hymn2_string_array));

        listAdapter = new ListAdapter(this, hymn2_list);
