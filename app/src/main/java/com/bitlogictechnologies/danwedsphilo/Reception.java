...
public class Reception extends AppCompatActivity {
    ...
    ListView lv_order;
    ArrayList<String> reception_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_title_text.setText("\tReception");
    ...
    public void load_service_order(){
        ...
        final String [] reception_string_array= dataArray.reception_order;
        reception_list=new ArrayList<String>(Arrays.asList(reception_string_array));

        listAdapter = new ListAdapter(this, reception_list);
